...
abstract class _InstanceDefaultEnumPropsGetter
    implements InstanceDefaultEnumPropsGetter<$GestureRecognizerState> {}

// OBRIGATÓRIO: Getter para index
class $GestureRecognizerStateGetterIndex
  ...
  @override
  $Value? run(Runtime runtime, $GestureRecognizerState target) {
    return $int(target.$reified.index);
  }
}

// OBRIGATÓRIO: Getter para name
class $GestureRecognizerStateGetterName
    implements _InstanceDefaultEnumPropsGetter {
  @override
