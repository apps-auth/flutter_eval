...
abstract class _InstanceDefaultPropsMethod
    implements InstanceDefaultPropsMethod<$BeveledRectangleBorder> {}

// Método copyWith
class $BeveledRectangleBorderMethodCopyWith
  ...
  @override
  $Value? run(
      Runtime runtime, $BeveledRectangleBorder target, List<$Value?> args) {
...
// Método scale
class $BeveledRectangleBorderMethodScale
    implements _InstanceDefaultPropsMethod {
  @override
...
// Método lerpFrom
class $BeveledRectangleBorderMethodLerpFrom
    implements _InstanceDefaultPropsMethod {
  @override
...
// Método lerpTo
class $BeveledRectangleBorderMethodLerpTo
    implements _InstanceDefaultPropsMethod {
  @override
