...
abstract class _InstanceDefaultPropsMethod
    implements InstanceDefaultPropsMethod<$RenderAspectRatio> {}

class $RenderAspectRatioMethodPerformLayout
  ...
  @override
  $Value? run(Runtime runtime, $RenderAspectRatio target, List<$Value?> args) {
    target.$reified.performLayout();
    return null;
  }
}

class $RenderAspectRatioMethodComputeDryLayout
    implements _InstanceDefaultPropsMethod {
  @override
