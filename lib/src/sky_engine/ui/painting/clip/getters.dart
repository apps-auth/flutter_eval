...
abstract class _InstanceDefaultEnumPropsGetter
    implements InstanceDefaultEnumPropsGetter<$Clip> {}

class $ClipGetterIndex implements _InstanceDefaultEnumPropsGetter {
  @override
  ...
  @override
  $Value? run(Runtime runtime, $Clip target) {
    return $int(target.$reified.index);
  }
}

class $ClipGetterName implements _InstanceDefaultEnumPropsGetter {
  @override
